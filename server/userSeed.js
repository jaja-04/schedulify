...
const facultyEmails = [
  ...
  "franciscodiaz@g.batstate-u.edu.ph", "rosarioesperanza@g.batstate-u.edu.ph", "luisferrer@g.batstate-u.edu.ph",
  "gloriagonzales@g.batstate-u.edu.ph", "ricardoherrera@g.batstate-u.edu.ph", "mariaiglesias@g.batstate-u.edu.ph",
  "javierjimenez@g.batstate-u.edu.ph", "kristinakim@g.batstate-u.edu.ph", "lorenzolazaro@g.batstate-u.edu.ph",
  "martamendoza@g.batstate-u.edu.ph", "nicolasnatividad@g.batstate-u.edu.ph", "oliviaocampo@g.batstate-u.edu.ph",
  "pablopascual@g.batstate-u.edu.ph", "quirinoquezon@g.batstate-u.edu.ph", "rafaelramirez@g.batstate-u.edu.ph",
  "sofiasantos@g.batstate-u.edu.ph", "tomastreyes@g.batstate-u.edu.ph", "ursulauy@g.batstate-u.edu.ph",
  "vicentevillanueva@g.batstate-u.edu.ph", "wendywu@g.batstate-u.edu.ph", "xavierximenez@g.batstate-u.edu.ph",
  "yolandayap@g.batstate-u.edu.ph", "zachariaszamora@g.batstate-u.edu.ph", "angelaabad@g.batstate-u.edu.ph",
  "bernardobautista@g.batstate-u.edu.ph", "claracaballero@g.batstate-u.edu.ph", "danieldelrosario@g.batstate-u.edu.ph",
  "elenaevangelista@g.batstate-u.edu.ph", "felipefelix@g.batstate-u.edu.ph", "gracegalvez@g.batstate-u.edu.ph",
  "henryherrera@g.batstate-u.edu.ph", "isabellejavier@g.batstate-u.edu.ph", "josejimenez@g.batstate-u.edu.ph",
  "katherineko@g.batstate-u.edu.ph", "leoluna@g.batstate-u.edu.ph", "marthamarquez@g.batstate-u.edu.ph",
  "nelsonnavarro@g.batstate-u.edu.ph", "oliviaortega@g.batstate-u.edu.ph", "patriciapaz@g.batstate-u.edu.ph",
  "quincyquiambao@g.batstate-u.edu.ph", "ricardoramos@g.batstate-u.edu.ph", "samuelsantiago@g.batstate-u.edu.ph",
  "teresatolentino@g.batstate-u.edu.ph", "ulyssesuy@g.batstate-u.edu.ph", "victoriavillanueva@g.batstate-u.edu.ph",
  "williamwong@g.batstate-u.edu.ph", "ximenaximenes@g.batstate-u.edu.ph", "yvetteyang@g.batstate-u.edu.ph"
];

// Student emails with 22- prefix
const studentEmails = [
  "22-00001@g.batstate-u.edu.ph", "22-00002@g.batstate-u.edu.ph", "22-00003@g.batstate-u.edu.ph",
